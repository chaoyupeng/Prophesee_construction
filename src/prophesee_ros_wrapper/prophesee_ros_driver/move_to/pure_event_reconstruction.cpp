...
High_pass_filter::High_pass_filter(ros::NodeHandle & nh, ros::NodeHandle nh_private)
{
  ...
  //将intensity估计发布到我们的 intensity estimate 这个topic上去
...
//下面就是我们的eventscallback
//也就是high pass filter 
//这个东西的type是我们的dvs_msgs
//我们需要改变成我们的prophesee eventarray
void High_pass_filter::eventsCallback(const prophesee_event_msgs::EventArray::ConstPtr& msg)
{
